...
+ (NSString *)dateMonthDayTimeWithDate1:(NSDate *)date
{
    ...
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
    [formatter setDateFormat:[self timeFormatStringSpecial1]];
    NSString *str = [formatter stringFromDate:date];
    return str;
}
+ (NSString *)dateMonthDayTimeWithDate2:(NSDate *)date
{
    ...
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
    [formatter setDateFormat:[self timeFormatStringSpecial2]];
    NSString *str = [formatter stringFromDate:date];
    return str;
}
+ (NSString *)dateMonthDayTimeWithDate3:(NSDate *)date
{
    ...
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
    [formatter setDateFormat:[self timeFormatStringSpecial3]];
    NSString *str = [formatter stringFromDate:date];
    return str;
}
+ (NSString *)dateMonthDayTimeWithDate4:(NSDate *)date
{
    ...
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
    [formatter setDateFormat:[self timeFormatStringSpecial4]];
    NSString *str = [formatter stringFromDate:date];
    return str;
}
...
+ (NSString *)timeFormatStringSpecial1
{
    return @"M月d日";
}
+ (NSString *)timeFormatStringSpecial2
{
    return @"HH:mm";
}
+ (NSString *)timeFormatStringSpecial3
{
    return @"M月d日 HH:mm";
}
+ (NSString *)timeFormatStringSpecial4
{
    return @"dd/MM";
}
